...
WEB_APP_CONF = {
    ...
    'factors': {
        'tissue': {
            'level_order': ['cerebral_cortex', 'hypothalamus'],
            'level_shapes': {
                'cerebral_cortex': CIRCLE,
                'hypothalamus': DIAMOND,
            },
        },
        'time': {
            'level_order': ['0hrs', '3hrs', '6hrs', '9hrs', '12hrs'],
            'level_styles': {
                '0hrs': {
                    'fill': 'grey',
                    'fill-opacity': '0.3',
        ...
        'treatment': {
            'level_order': ['none', 'sleep', 'sleepdeprivation'],
        },
    },
    ...
    'x_axis_factors': [
        ...
        {
            'label': 'Tissue x Treatment x Time',
            'factors': ['tissue', 'time', 'treatment']
        },
    ],
